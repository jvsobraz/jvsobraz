...
<br>- Management: Agile, Scrum, UX, QA.<br>- Backend: Java, Python, C#, Node.js, Spring Framework.<br>- Frontend: HTML, CSS, Javascript, ReactJS.<br>- Mobile: React Native.<br>- Database:  Oracle, SQL Server, MySQL, PL/SQL.<br>- Cloud: Docker, Linux.<br>- DevOps: Microsoft Azure, Git, Github.<br>- API: Rest, Microservices.<br>- AI & ChatBot: Node Red, Pandas.<br> <br> Nowadays I'm focused and working in C# . NET <br> <br>- 💼 Working at Frogpay.<br>- 📫 How to reach me: jvsobraz@hotmail.com / jvsobraz@gmail.com
